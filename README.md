# [LSK-YOLOv10: A improved model from the YOLOv10](https://arxiv.org/abs/2405.14458)


A fork copy from the Official PyTorch implementation of [YOLOv10: Real-Time End-to-End Object Detection](https://arxiv.org/abs/2405.14458).
...
| [Modle 1](https://huggingface.co/jameslahm/yolov10s)     |   640  |     7.2M    |   21.6G  |     46.3%     | 2.49ms |
| [Modle 2](https://huggingface.co/jameslahm/yolov10m)     |   640  |     15.4M   |   59.1G  |     51.1%     | 4.74ms |
| [Modle 3](https://huggingface.co/jameslahm/yolov10b)     |   640  |     19.1M   |  92.0G |     52.5%     | 5.74ms |
| [LSK-YOLOv10](https://huggingface.co/jameslahm/yolov10l) |   640  |     24.4M   |  120.3G   |     53.2%     | 7.28ms |

## Installation
`conda` virtual environment is recommended. 
```
conda create -n yolov10 python=3.10.11
